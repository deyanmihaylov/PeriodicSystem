...
\newcommand{\CommonElementTextFormat}[4]
{
	...
	{\textbf{\fontsize{10}{30}\selectfont#1} \hfill {\fontsize{10}{0}\selectfont#2}}\\
	\hspace{-2pt}\textbf{\fontsize{30}{0}\selectfont#3}\\[-4.25pt]
	{\fontsize{10}{0}\selectfont#4}
	\end{minipage}
}
...
%% Fill Color Styles
  \tikzstyle{ElementFill} = [fill=green]
...
%% Element Styles
  \tikzstyle{Element} = [ElementFill, minimum width=2.75cm, minimum height=2.75cm, node distance=3cm, rounded corners=0.1cm]
...
%% Group 1 - IA1.0079
  \node[name=H, Element] {\NaturalElementTextFormat{1}{}{H}{HYDROGEN}};
